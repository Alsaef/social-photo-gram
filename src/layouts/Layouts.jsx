...
const handelLogOut=()=>{
  ...
  <div className="drawer-side">
    ...
    <ul className="menu p-4 w-[205px] h-[100vh] bg-gradient-to-r from-blue-500 to-blue-700 text-white">
...
<div className="avatar">
  ...
  <div tabIndex={0} role="button" className="btn from-blue-500 to-blue-700  hover:from-blue-500  text-black"><FontAwesomeIcon icon={faBars}/> More</div>
  <div tabIndex={0} className="dropdown-content z-[1] menu p-0  mt-2 text-white rounded-box w-[140px]">
{
 email?<><button onClick={handelLogOut} className='btn from-blue-500 to-blue-700   hover:from-blue-500   text-black'><FontAwesomeIcon icon={faArrowLeft}/> LogOut</button></>: <Link to='/login'><button className='btn bg-amber-300  hover:bg-amber-300  text-white'><p className='flex items-center gap-3'><FontAwesomeIcon icon={faArrowLeft}/> <span>Login</span></p></button></Link>
}
<Link to='/report'><button className='btn from-blue-500 to-blue-700   hoverfrom-blue-500 text-black mt-2 '><p className='flex items-center gap-2'><FontAwesomeIcon icon={faBug}/> <span>Report a Problem</span></p></button></Link>
  </div>
</div>
    </ul>
